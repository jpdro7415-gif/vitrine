...
// Espera os dados do Supabase chegarem antes de montar a página.
// Se por algum motivo já estiverem prontos (carregamento rápido),
// inicia na hora também.
if (window.LOJAS_VITRINE) {
    iniciarLoja();
} else {
    window.addEventListener("vitrine-dados-prontos", iniciarLoja);
}
